...
import org.JoaquinGonzalez.model.DetalleFactura;
...
public class MenuDetalleFacturaController implements Initializable {
    ...
    @FXML
    TextField tfDetalleFacturaId, tfBuscarId;
    @FXML
    ...
    public ObservableList<DetalleFactura> listarDetalleFactura(){
        ...
        try{
            ...
            while(resultSet.next()){
                ...
                detalleFactura.add(new DetalleFactura(detalleFacturaId, factura, producto));
            }
    ...
    public void agregarDetalleFactura(){
        try{
            ...
            statement = conexion.prepareStatement(sql);
            statement.setInt(1, ((Facturas)cmbFactura.getSelectionModel().getSelectedItem()).getFacturaId());
    ...
    public void editarDetalleFactura(){
        try{
            ...
            statement.setInt(2, ((Facturas)cmbFactura.getSelectionModel().getSelectedItem()).getFacturaId());
